...
export type DecrementInput<TAccountNotesdapp extends string = string> = {
...
>(
  input: DecrementInput<TAccountNotesdapp>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountNotesdapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.notesdapp)],
    programAddress,
    data: getDecrementInstructionDataEncoder().encode({}),
  } as DecrementInstruction<TProgramAddress, TAccountNotesdapp>;
