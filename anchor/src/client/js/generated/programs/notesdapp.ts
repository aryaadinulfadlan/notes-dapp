...
export function identifyNotesdappAccount(
  ...
  if (
    ...
    return NotesdappAccount.Notesdapp;
  }
  throw new Error(
...
export function identifyNotesdappInstruction(
  ...
  if (
    ...
    return NotesdappInstruction.Close;
  }
  if (
    containsBytes(
      data,
    ...
    return NotesdappInstruction.Decrement;
  }
  if (
    containsBytes(
      data,
    ...
    return NotesdappInstruction.Increment;
  }
  if (
    containsBytes(
      data,
    ...
    return NotesdappInstruction.Initialize;
  }
  if (
    containsBytes(
      data,
    ...
    return NotesdappInstruction.Set;
  }
  throw new Error(
...
> =
  ...
  | ({
      instructionType: NotesdappInstruction.Decrement;
    } & ParsedDecrementInstruction<TProgram>)
  | ({
      instructionType: NotesdappInstruction.Increment;
    } & ParsedIncrementInstruction<TProgram>)
  | ({
      instructionType: NotesdappInstruction.Initialize;
    } & ParsedInitializeInstruction<TProgram>)
  | ({
      instructionType: NotesdappInstruction.Set;
